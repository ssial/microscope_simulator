        ...
        return (
            <React.Fragment>
                <div style={styles.outerCircle}>
                    ...
                    <img style={{margin:"-20% -100%",maxHeight:"100vh",transform:`translateY(${this.props.yOffset}%) translateX(${this.props.xOffset}%) scale(${this.props.scale})`, filter:`blur(${this.props.blur}em)`}}src={specimen1}/>
                    </div>
                </div>
            </React.Fragment>
        )
